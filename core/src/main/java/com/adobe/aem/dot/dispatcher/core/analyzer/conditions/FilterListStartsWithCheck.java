...
/**
 * Check that a Filter list starts with a particular Filter.
 */
public class FilterListStartsWithCheck extends Check {
  private static final Logger logger = LoggerFactory.getLogger(FilterListStartsWithCheck.class);

  @Override
  public Condition getCondition() {
    return Condition.FILTER_LIST_STARTS_WITH;
  }
  ...
  public CheckResult performCheck(Object configurationValue) {
    ...
    try {
      ...
      logger.error("Value could not be cast to a filter list. Value=\"{}\"", configurationValue);
    }
