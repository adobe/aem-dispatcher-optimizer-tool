...
/**
 * Check that an int value is greater than or equal to the value specified.
 */
public class IntGreaterOrEqualCheck extends IntCheck {
  @Override
  public Condition getCondition() {
    return Condition.INT_GREATER_OR_EQUAL;
  }
